...
//        console.log(cls);
//        if(cls == "skin-black"){
//        	$('.layui-this').css("background-color","#fff");
//        	$('.layui-this').css("color","#000");
//        }
//        if( cls == "skin-green"){
//        	$('.layui-this').css("background-color","#00a65a");
//        	$('.layui-this').css("color","#fff");
//        }
//        
        $('body').addClass(cls)
        store('skin', cls)
    ...
    function setup() {
        ...
        $('[data-controlsidebar]').on('click', function () { //工具栏弹出样式设置
        ...
        $('[data-sidebarskin="toggle"]').on('click', function () { //切换工具栏样式设置
        ...
        $('[data-enable="expandOnHover"]').on('click', function () { //菜单栏设置
    ...
    var $skinBlackLight =
        $('<li />', {style: 'float:left; width: 33.33333%; padding: 5px;'})
            .append('<a href="javascript:void(0)" data-skin="skin-black-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
                ...
                + '<div><span style="display:block; width: 20%; float: left; height: 20px; background: #f9fafc"></span><span style="display:block; width: 80%; float: left; height: 20px; background: #f4f5f7"></span></div>'
                + '</a>'
                + '<p class="text-center no-margin" style="font-size: 12px">亮白色</p>')
