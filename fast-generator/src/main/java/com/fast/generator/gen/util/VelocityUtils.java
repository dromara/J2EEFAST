...
import com.fast.generator.gen.config.GenConfig;
...
public class VelocityUtils
{
    ...
    public static VelocityContext prepareContext(GenTableEntity genTable)
    {
        ...
        velocityContext.put("createBy", ShiroUtils.getUserEntity().getUsername());
        velocityContext.put("updateBy", ShiroUtils.getUserEntity().getUsername());
    ...
    public static String getFileName(String template, GenTableEntity genTable)
    {
        ...
        String fileName = "";
        // 包路径
        String packageName = genTable.getPackageName(); //com.fast.bcs.tbc
        // 模块名
